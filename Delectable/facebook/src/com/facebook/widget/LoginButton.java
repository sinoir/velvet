 ...
 * require user interaction (i.e. if the session is in the {@link com.facebook.SessionState#CREATED_TOKEN_LOADED}
...
public class LoginButton extends Button {
     ...
     * open. If this is called after the session is opened, and the list of permissions passed in is
     * not a subset of the permissions granted during the authorization, it will log an error. <p/>
    ...
    /**
     * Sets the login behavior for the session that will be opened. If null is specified, the
     * default ({@link SessionLoginBehavior SessionLoginBehavior.SSO_WITH_FALLBACK} will be used.
     *
    ...
    /**
     * Sets the style (background) of the Tool Tip popup. Currently a blue style and a black style
     * are supported. Blue is default
     *
     ...
     *                    onActivityResult occurs as part of Facebook authorization flow, this value
     *                    is the activityCode passed to open or authorize.
     ...
     * reused, if the user logs out from this Session, and tries to log in again, a new Active
     * Session will be used instead. <p/> If the passed in session is currently opened, this method
     * will also attempt to load some user information for display (if needed).
     *
    ...
    /**
     * Sets the fragment that contains this control. This allows the LoginButton to be embedded
     * inside a Fragment, and will allow the fragment to receive the {@link
    ...
    private void parseAttributes(AttributeSet attrs) {
        TypedArray a = getContext()
                .obtainStyledAttributes(attrs, R.styleable.com_facebook_login_view);
            ...
            if (currentSession != null) {
                if (currentSession != userInfoSession) {
                    Request request = Request
                            .newMeRequest(currentSession, new Request.GraphUserCallback() {
                                @Override
    ...
    /**
     * Allow a developer to set the OnClickListener for the button.  This will be called back after
     * we do any handling internally for login
     */
    @Override
        ...
        public void onClick(View v) {
            ...
            if (openSession != null) {
                ...
                if (confirmLogout) {
                    ...
                    String logout = getResources()
                            .getString(R.string.com_facebook_loginview_log_out_action);
                    String cancel = getResources()
                            .getString(R.string.com_facebook_loginview_cancel_action);
                    String message;
