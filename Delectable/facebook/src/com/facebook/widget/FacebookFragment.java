 ...
 * class is package private, and is not intended to be consumed by external applications.</p>
 *
...
class FacebookFragment extends Fragment {
     ...
     * when a session is opened. If this method is overridden in subclasses, be sure to call {@code
     ...
     * this method will default to using the values from the associated meta-data value and an empty
     * list respectively.
     *
    ...
    /**
     * Opens a new session with publish permissions. If either applicationID is null, this method
     * will default to using the value from the associated meta-data value. The permissions list
     * cannot be null.
     *
     * @param applicationId the applicationID, can be null
