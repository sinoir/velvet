...
public class ChoosePaymentMethodAdapter extends BaseAdapter {
    ...
    private List<PaymentMethod> mData = new ArrayList<PaymentMethod>();

    private ChoosePaymentMethodDialogRow.ActionsHandler mRowActionsHandler;
    ...
    public void setRowActionsHandler(
            ChoosePaymentMethodDialogRow.ActionsHandler rowActionsHandler) {
    ...
    private View getAddressRowView(int position, View convertView, ViewGroup parent) {
        ChoosePaymentMethodDialogRow row = (ChoosePaymentMethodDialogRow) convertView;
        if (row == null) {
            LayoutInflater inflater = LayoutInflater.from(parent.getContext());
            row = (ChoosePaymentMethodDialogRow) inflater
                    .inflate(R.layout.row_choose_payment_method_impl, parent, false);
    ...
    private View getFooterRowView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row.setText(R.string.paymentmethod_add_another);
