...
public enum Rating {
    EXQUISITE(30.0f, 9.0f, R.color.d_rating_exquisite),
    GOOD(20.0f, 8.0f, R.color.d_rating_good),
    OK(10.0f, 7.0f, R.color.d_rating_ok),
    BAD(0.0f, 6.0f, R.color.d_rating_bad),
    NO_RATING(-1.0f, -1.0f, R.color.d_black);
    ...
    private Rating(float startValue40, float startValue10, int colorRes) {
